          ...
          <div className="col-lg-5 offset-lg-1 valign">
            <div className="cont">
              <div className="sub-title">
                <h6>Who is Tawonga?</h6>
                <span></span>
                <span></span>
                <span></span>
              </div>
              <h3 className="mb-30 fw-700">Investing in <br /> the digital future.</h3>
              <p>Since my establishment in 2018, I have been focusing on Creativity & implementation through cooperation.</p>
              <p>In total, i have created more than 2000 projects related to constructional designing and landscaping worldwide.</p>
            </div>
          </div>
        </div>
      </div>
