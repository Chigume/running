            ...
            <div className="col-lg-5 offset-lg-1">
              <div className="cont-info">
                ...
                <div className="item mb-40">
                  <h5>
                    <a href="#0">info@tawongamakotose.com</a>
                  </h5>
                  <h5>+263 77 603 7011</h5>
                  <h5>+263 71 701 8825</h5>
                </div>
                <Split>
                  <h3 className="custom-font wow" data-splitting>
                    Visit Us.
        ...
        <div className="container">
          <div className="copyrights text-center mt-0">
            <p>
              ...
              <a href="www.linkedin.com/in/abgirl-chigume-8007181b8" target="_blank">Abgirl Chigume</a>.
            </p>
          </div>
        </div>
      </footer>
