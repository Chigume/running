  ...
  return (
    <DarkTheme>
      ...
      <header
        ...
        style={{ backgroundImage: "url(/img/demos/aaa.png)" }}
        data-overlay-dark="4"
      >
          ...
          <div className="row justify-content-center">
            <div className="col-lg-9 col-md-11 static">
              <div className="capt mt-50">
                <div className="parlx">
                  <h2 className="custom-font">The Youth Ministry of UFIC</h2>
                  <p>
                  #godnation #uficyth #fillupthepav #emmanuelmakandiwa #ruthemmanuelmakandiwa
                  </p>
                </div>
        ...
        <section className="masonery section-padding sub-bg">
          <div className="container-fluid">
            <div className="sec-head custom-font text-center">
              ...
              <span className="tbg">uficyouth</span>
            </div>
              ...
              <div className="gallery full-width">
                <div className="col-lg-4 col-md-6 items graphic">
                  <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <img src="/img/demos/b.png" alt="image" />
                  </div>
                  <div className="cont">
                    <h6>Ihub Connect</h6>
                  </div>
